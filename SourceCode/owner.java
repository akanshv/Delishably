...
public class Owner extends JDBC_Connection
{
    Scanner input=new Scanner();


    void insert_manager(int ID, String Name, String Position, int Salary, int age, String Gender, String Branch_ID) 
    {
        // Add Manager Controller CLass

        // insertEmployee Function fron absrtract class
        st.executeUpdate("insert into manager values(%d,%s,%s,%d,%d,%s,%s);",ID,Name,Position,Salary,Gender,Branch_ID);
    }

    void delete_manager(int ID) 
    {
        // Delete Manager Controller class
        ...
        st.executeUpdate("Delete from manager where employee_id= %d",ID);
    }

    void update_employee(int ID, String Name, String Position, int Salary, int age, String Gender, Strimg Branch_ID)
    {
        // Update Manager Controller class

        // Statement st = con.Statement(query);
        // Update Manager Class
        st.executeUpdate("Update Manager set Name= %s, Position = %s, Salary = %d, Age = %d, Gender = %s, Branch_ID = %d where Employee_Id = %d",Name,Position,Salary,Age,Gender,ID, Branch_ID);
    }

    void insert_branch(int Branch_Id, int Manager_ID,String City_NAme, String Address) 
    {
        // Add Branch Controller CLass

        // insertEmployee Function fron absrtract class
        st.executeUpdate("insert into branch values(%d,%d,%s,%s);",Branch_Id,Manager_ID,City_Name,Address);
    }

    void delete_branch(int ID) 
    {
        // Delete Branch Controller class
        ...
        st.executeUpdate("Delete from branch where employee_id= %d",ID);
    }
